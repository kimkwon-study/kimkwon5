...
public class BoardController {
    ...
    @PostMapping("/save")
    public JsonResponse<BoardResponse> save(@RequestBody BoardSaveRequest request){
    ...
    public JsonResponse<BoardResponse> update(@PathVariable("id") String id,@RequestBody BoardSaveRequest req){
